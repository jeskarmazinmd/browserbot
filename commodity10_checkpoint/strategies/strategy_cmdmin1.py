"""Self-contained bounded prospective commodity/macro ETF experiment: CMDMIN1."""
...
MODE='LEAD'
PARAMS={'leader': 'GLD', 'follower': 'GDX', 'lookback': 10, 'lead': 0.35, 'lagmax': 0.15, 'target': 0.9, 'stop': 0.7}
