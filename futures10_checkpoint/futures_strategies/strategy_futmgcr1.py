"""Self-contained prospective micro-futures experiment: FUTMGCR1."""
from __future__ import annotations
from collections import defaultdict,deque
from datetime import datetime,timezone
import math,statistics
STRATEGY_ID='FUTMGCR1';FAMILY="FUTURES10";PAPER_ONLY=True;LIVE_ORDER_PLACEMENT=False;FORWARD_START_UTC="2026-08-09T22:00:00+00:00";MODE='REV';PARAMS={'root': '/MGC', 'lookback': 15, 'move': 0.3, 'rebound': 0.08, 'tp': 50, 'sl': 40, 'hold': 90};MAX_HISTORY=61
