"""FCOILM1: follow persistent Micro WTI curve shocks rather than fade them."""
from collections import deque
from datetime import datetime,timezone
import statistics
STRATEGY_ID="FCOILM1";FAMILY="FUTURES_CURVE6";PAPER_ONLY=True;LIVE_ORDER_PLACEMENT=False;FORWARD_START_UTC="2026-08-09T22:00:00+00:00";ROOT="/MCL";MODE="MOMENTUM";Z_TRIGGER=1.5;MAX_COST=140.;TP=180.;SL=150.;HOLD=720;MIN_HISTORY=24
class Strategy:
 name=STRATEGY_ID
 ...
 def evaluate(self,s):
  ...
  self.last=now;deferred="LONG" if z>0 else "SHORT";front="SHORT" if z>0 else "LONG";legs=[{"symbol":a["symbol"],"side":front,"bid":a["bid"],"ask":a["ask"],"multiplier":a["multiplier"],"expiration":a["expiration_ms"]},{"symbol":b["symbol"],"side":deferred,"bid":b["bid"],"ask":b["ask"],"multiplier":b["multiplier"],"expiration":b["expiration_ms"]}]
