"""FCMES1: mean-revert unusual Micro E-mini S&P calendar carry."""
from collections import deque
from datetime import datetime,timezone
import statistics
STRATEGY_ID="FCMES1";FAMILY="FUTURES_CURVE6";PAPER_ONLY=True;LIVE_ORDER_PLACEMENT=False;FORWARD_START_UTC="2026-08-09T22:00:00+00:00";ROOT="/MES";MODE="MEAN_REVERSION";Z_TRIGGER=1.6;MAX_COST=70.;TP=100.;SL=100.;HOLD=1440;MIN_HISTORY=24
class Strategy:
 name=STRATEGY_ID
