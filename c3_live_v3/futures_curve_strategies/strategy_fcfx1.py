"""FCFX1: mean-revert Micro EUR/USD futures calendar carry."""
from collections import deque
from datetime import datetime,timezone
import statistics
STRATEGY_ID="FCFX1";FAMILY="FUTURES_CURVE6";PAPER_ONLY=True;LIVE_ORDER_PLACEMENT=False;FORWARD_START_UTC="2026-08-09T22:00:00+00:00";ROOT="/M6E";MODE="MEAN_REVERSION";Z_TRIGGER=1.5;MAX_COST=65.;TP=90.;SL=80.;HOLD=1440;MIN_HISTORY=24
class Strategy:
 name=STRATEGY_ID
