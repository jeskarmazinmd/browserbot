"""Self-contained prospective micro-futures experiment: FUTMCL1."""
from __future__ import annotations
from collections import defaultdict,deque
from datetime import datetime,timezone
import math,statistics
STRATEGY_ID='FUTMCL1';FAMILY="FUTURES10";PAPER_ONLY=True;LIVE_ORDER_PLACEMENT=False;FORWARD_START_UTC="2026-08-09T22:00:00+00:00";MODE='TREND';PARAMS={'root': '/MCL', 'lookback': 20, 'move': 0.35, 'tp': 45, 'sl': 35, 'hold': 120};MAX_HISTORY=61
