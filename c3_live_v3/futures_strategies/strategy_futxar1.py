"""Self-contained prospective micro-futures experiment: FUTXAR1."""
from __future__ import annotations
from collections import defaultdict,deque
from datetime import datetime,timezone
import math,statistics
STRATEGY_ID='FUTXAR1';FAMILY="FUTURES10";PAPER_ONLY=True;LIVE_ORDER_PLACEMENT=False;FORWARD_START_UTC="2026-08-09T22:00:00+00:00";MODE='DIVERGE';PARAMS={'a': '/MGC', 'b': '/MES', 'lookback': 20, 'spread': 0.45, 'tp': 80, 'sl': 60, 'hold': 150};MAX_HISTORY=61
