"""Independent paper-only C3-family experiment: Standalone C3 control: 0.20% rebound, lower-quotes exit."""

from typing import Any, Mapping

STRATEGY_ID = 'C3SC'
DESCRIPTION = 'Standalone C3 control: 0.20% rebound, lower-quotes exit'
FAMILY = "C3X"
PAPER_ONLY = True
EXIT_MODEL = 'c3'

CONFIG = {'flash_drop_pct': 1.0, 'rebound_confirmation_pct': 0.002, 'stop_loss_fraction': 0.02, 'activation_gain_pct': 0.3, 'live_order_placement': False, 'lower_samples': 3, 'min_total_decline_pct': 0.1}
