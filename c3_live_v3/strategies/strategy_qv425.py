"""Standalone prospective paper experiment: Independent Q-style entry requiring >=4.25 volatility units."""
...
STRATEGY_ID = "QV425"
DESCRIPTION = "Independent Q-style entry requiring >=4.25 volatility units"
FAMILY = "QX"
PAPER_ONLY = True
