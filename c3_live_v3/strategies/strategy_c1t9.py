"""Standalone prospective paper experiment: Independent C1-style entry with target price <= $9."""
...
STRATEGY_ID = "C1T9"
DESCRIPTION = "Independent C1-style entry with target price <= $9"
FAMILY = "C1X"
PAPER_ONLY = True
...
def refresh_event_for_entry(event: Mapping[str, Any], current_price: float) -> dict[str, Any]:
    ...
    refreshed.update({'exit_model': 'c1', 'activation_gain_pct': 0.3, 'pullback_from_high_pct': 0.2})
    return refreshed
