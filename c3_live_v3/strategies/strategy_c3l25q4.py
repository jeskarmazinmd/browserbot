"""Independent paper-only C3-family experiment: 0.25% rebound, C3 exit with 4 lower quotes."""

from typing import Any, Mapping

STRATEGY_ID = 'C3L25Q4'
DESCRIPTION = '0.25% rebound, C3 exit with 4 lower quotes'
FAMILY = "C3X"
PAPER_ONLY = True
EXIT_MODEL = 'c3'

CONFIG = {'flash_drop_pct': 1.0, 'rebound_confirmation_pct': 0.0025, 'stop_loss_fraction': 0.02, 'activation_gain_pct': 0.3, 'live_order_placement': False, 'lower_samples': 4, 'min_total_decline_pct': 0.1}
