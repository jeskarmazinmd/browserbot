...
APP_KEY=$(grep '^SCHWAB_TRADE_APP_KEY=' schwabtradekey.txt | cut -d= -f2-)
APP_SECRET=$(grep '^SCHWAB_TRADE_SECRET=' schwabtradekey.txt | cut -d= -f2-)
...
printf 'put schwab_trade_token.json /data/schwab_trade_token_new.json\n' | fly sftp shell -a schwab
