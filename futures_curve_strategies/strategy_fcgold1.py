"""FCGOLD1: mean-revert Micro Gold calendar-carry dislocations."""
from collections import deque
from datetime import datetime,timezone
import statistics
STRATEGY_ID="FCGOLD1";FAMILY="FUTURES_CURVE6";PAPER_ONLY=True;LIVE_ORDER_PLACEMENT=False;FORWARD_START_UTC="2026-08-09T22:00:00+00:00";ROOT="/MGC";MODE="MEAN_REVERSION";Z_TRIGGER=1.5;MAX_COST=140.;TP=160.;SL=140.;HOLD=1440;MIN_HISTORY=24
class Strategy:
 name=STRATEGY_ID
