"""FCMNQ1: mean-revert unusual Micro Nasdaq calendar carry."""
from collections import deque
from datetime import datetime,timezone
import statistics
STRATEGY_ID="FCMNQ1";FAMILY="FUTURES_CURVE6";PAPER_ONLY=True;LIVE_ORDER_PLACEMENT=False;FORWARD_START_UTC="2026-08-09T22:00:00+00:00";ROOT="/MNQ";MODE="MEAN_REVERSION";Z_TRIGGER=1.6;MAX_COST=160.;TP=180.;SL=160.;HOLD=1440;MIN_HISTORY=24
class Strategy:
 name=STRATEGY_ID
