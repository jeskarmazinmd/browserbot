...
SIGNAL_PAPER_OUTCOMES_E_JSONL = Path("/data/signal_paper_outcomes_strategy_e_liquidity_v1.jsonl")
NEAR_MISS_PAPER_E_JSONL = Path("/data/near_miss_paper_outcomes_strategy_e_liquidity_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_F_JSONL = Path("/data/signal_paper_outcomes_strategy_f_d_volume_ratio_v1.jsonl")
NEAR_MISS_PAPER_F_JSONL = Path("/data/near_miss_paper_outcomes_strategy_f_d_volume_ratio_v1.jsonl")
...
SIGNAL_PAPER_OUTCOMES_G_JSONL = Path("/data/signal_paper_outcomes_strategy_g_c4_stop_1_5_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_H_JSONL = Path("/data/signal_paper_outcomes_strategy_h_filtered_broad_rebound_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_I_JSONL = Path("/data/signal_paper_outcomes_strategy_i_fast_confirmation_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_J1_JSONL = Path("/data/signal_paper_outcomes_strategy_j1_stop_1pct_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_J2_JSONL = Path("/data/signal_paper_outcomes_strategy_j2_stop_0_5pct_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_J3_JSONL = Path("/data/signal_paper_outcomes_strategy_j3_15s_no_progress_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_J4_JSONL = Path("/data/signal_paper_outcomes_strategy_j4_30s_no_progress_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_J5_JSONL = Path("/data/signal_paper_outcomes_strategy_j5_60s_no_progress_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_J6_JSONL = Path("/data/signal_paper_outcomes_strategy_j6_30s_no_progress_stop_0_5pct_v1.jsonl")
K_EARLY_BEHAVIOR_JSONL = Path("/data/strategy_k_early_behavior_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_L_JSONL = Path("/data/signal_paper_outcomes_strategy_l_exhaustion_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_M_JSONL = Path("/data/signal_paper_outcomes_strategy_m_rolling_vwap_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_N_JSONL = Path("/data/signal_paper_outcomes_strategy_n_adaptive_trail_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_O_JSONL = Path("/data/signal_paper_outcomes_strategy_o_second_leg_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_P_JSONL = Path("/data/signal_paper_outcomes_strategy_p_strong_stock_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_Q_JSONL = Path("/data/signal_paper_outcomes_strategy_q_vol_normalized_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_R_JSONL = Path("/data/signal_paper_outcomes_strategy_r_morning_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_S_JSONL = Path("/data/signal_paper_outcomes_strategy_s_market_confirmed_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_TF1_JSONL = Path("/data/signal_paper_outcomes_tf1_trend_pullback_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_BO1_JSONL = Path("/data/signal_paper_outcomes_bo1_consolidation_breakout_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_OR1_JSONL = Path("/data/signal_paper_outcomes_or1_opening_range_breakout_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_RS1_JSONL = Path("/data/signal_paper_outcomes_rs1_relative_strength_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_RS2_JSONL = Path("/data/signal_paper_outcomes_rs2_relative_strength_exit_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_VE1_JSONL = Path("/data/signal_paper_outcomes_ve1_volatility_expansion_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_VR1_JSONL = Path("/data/signal_paper_outcomes_vr1_rolling_mean_reclaim_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_M1_JSONL = Path("/data/signal_paper_outcomes_m1_15m_reversal_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_M2_JSONL = Path("/data/signal_paper_outcomes_m2_30m_reversal_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_M3_JSONL = Path("/data/signal_paper_outcomes_m3_60m_reversal_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_RS3_JSONL = Path("/data/signal_paper_outcomes_rs3_tighter_exit_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_MC1_JSONL = Path("/data/signal_paper_outcomes_mc1_momentum_continuation_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_TL1_JSONL = Path("/data/signal_paper_outcomes_tl1_trendline_reclaim_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_AV1_JSONL = Path("/data/signal_paper_outcomes_av1_volatility_adaptive_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_TD1_JSONL = Path("/data/signal_paper_outcomes_td1_time_of_day_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_SH1_JSONL = Path("/data/signal_paper_outcomes_sh1_shape_flattening_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_CV1_JSONL = Path("/data/signal_paper_outcomes_cv1_curvature_reversal_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_HL1_JSONL = Path("/data/signal_paper_outcomes_hl1_higher_low_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_VT1_JSONL = Path("/data/signal_paper_outcomes_vt1_trendline_mean_confluence_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_PD1_JSONL = Path("/data/signal_paper_outcomes_pd1_panic_drop_snapback_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_EMA1_JSONL = Path("/data/signal_paper_outcomes_ema1_9_21_crossover_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_EMA2_JSONL = Path("/data/signal_paper_outcomes_ema2_pullback_bounce_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_EMA3_JSONL = Path("/data/signal_paper_outcomes_ema3_alignment_breakout_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_SMA1_JSONL = Path("/data/signal_paper_outcomes_sma1_20_50_crossover_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_VWEMA1_JSONL = Path("/data/signal_paper_outcomes_vwema1_mean_ema_momentum_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K1_JSONL = Path("/data/signal_paper_outcomes_strategy_k1_exit_30s_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K2_JSONL = Path("/data/signal_paper_outcomes_strategy_k2_exit_60s_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K3_JSONL = Path("/data/signal_paper_outcomes_strategy_k3_exit_120s_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K4_JSONL = Path("/data/signal_paper_outcomes_strategy_k4_30s_below_entry_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K5_JSONL = Path("/data/signal_paper_outcomes_strategy_k5_60s_below_entry_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K6_JSONL = Path("/data/signal_paper_outcomes_strategy_k6_60s_mfe_0_10_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K7_JSONL = Path("/data/signal_paper_outcomes_strategy_k7_60s_mfe_0_30_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K8_JSONL = Path("/data/signal_paper_outcomes_strategy_k8_60s_reach_0_20_v1.jsonl")
SIGNAL_PAPER_OUTCOMES_K9_JSONL = Path("/data/signal_paper_outcomes_strategy_k9_30min_timeout_v1.jsonl")
NEAR_MISS_PAPER_H_JSONL = Path("/data/near_miss_paper_outcomes_strategy_h_filtered_broad_rebound_v1.jsonl")
