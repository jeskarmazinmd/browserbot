"""Independent prospective paper experiment: C1F1 rules with 0.15 percent trailing pullback."""

from datetime import datetime, timezone
from typing import Any, Mapping
from zoneinfo import ZoneInfo

STRATEGY_ID = 'C1F1PB15'
DESCRIPTION = 'C1F1 rules with 0.15 percent trailing pullback'
FAMILY = 'C1F1X'
PAPER_ONLY = True
