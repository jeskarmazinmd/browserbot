"""Independent prospective paper experiment: Independent J2 entry with original target <= 14.822."""
...
STRATEGY_ID = 'J2T15'
DESCRIPTION = 'Independent J2 entry with original target <= 14.822'
FAMILY = 'J2X'
PAPER_ONLY = True
...
CONFIG = {
    ...
    "max_original_target_price": 14.822,
