"""Independent paper-only C3-family experiment: 0.20% rebound, C2 no-new-high exit."""

from typing import Any, Mapping

STRATEGY_ID = 'C3N20'
DESCRIPTION = '0.20% rebound, C2 no-new-high exit'
FAMILY = "C3X"
PAPER_ONLY = True
EXIT_MODEL = 'c2'

CONFIG = {'flash_drop_pct': 1.0, 'rebound_confirmation_pct': 0.002, 'stop_loss_fraction': 0.02, 'activation_gain_pct': 0.3, 'live_order_placement': False, 'no_new_high_seconds': 30.0}
