"""Snapshot-native M3 medium-reversal strategy."""
...
LOOKBACK_MINUTES = 60
MIN_DECLINE_PCT = 3.25
MIN_REBOUND_FROM_LOW_PCT = 0.40
MIN_REBOUND_2M_PCT = 0.15
TARGET_PCT = 1.25
STOP_PCT = 1.25
...
class M3Strategy(EventStrategy):
    ...
    def on_snapshot(
        ...
        for symbol, quote in snapshot.quotes.items():
            ...
            consider(self, symbol, snapshot.timestamp, current_price, [minimum("decline_pct", decline_pct, MIN_DECLINE_PCT, "%"), between("low_age_minutes", low_age_minutes, MEDIUM_REVERSAL_MIN_LOW_AGE_MINUTES, MEDIUM_REVERSAL_MAX_LOW_AGE_MINUTES, "minutes"), minimum("rebound_from_low_pct", rebound_from_low_pct, MIN_REBOUND_FROM_LOW_PCT, "%"), minimum("rebound_2m_pct", rebound_2m_pct, MIN_REBOUND_2M_PCT, "%"), boolean("prior_minute_above_low", prior_minute_above_low), maximum("largest_minute_share", largest_minute_share, MEDIUM_REVERSAL_MAX_SINGLE_MINUTE_SHARE)])
